...
SECRET_KEY = 'django-insecure-&qkmntq-296ig+dyoe^+u3dfi%hg%^tp%+o2$%rbf-w9&a5%n%'
...
# settings.py
OPENTOK_API_KEY = '7a7a6f5b'
OPENTOK_API_SECRET = 'FCwuaMbTnDs33p18'

# Reemplaza "..." con el contenido completo de tu clave privada.
